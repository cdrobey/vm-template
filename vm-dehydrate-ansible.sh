#!/bin/bash
#
# Ansible VMware Template Creation
#
#

echo "Removing openssh-server's host keys for root/ubuntu users."
rm -vf /etc/ssh/ssh_host_*
rm -vf ~root/.ssh/*
rm -vf ~ubuntu/.ssh/*

echo "Configuring /etc/rc.local for first boot."
...
history -c
cat /dev/null > ~ubuntu/.bash_history
history -c
